...
\todo{Describe how to practically use our code if they want to test
it, which file etc.}

\todo{Note that in the homework description the markovDecision function
has an upper case letter for the D but probably not important.}
